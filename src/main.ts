...
export type RPCTarget = mTarget.RPCTarget;
export const RPCTarget = mTarget.RPCTarget;
export type RPCWorker = mTarget.RPCWorker;
export const RPCWorker = mTarget.RPCWorker;
